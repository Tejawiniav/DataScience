...
# Read in the data
path='D[InternetShortcut]
URL=http://localhost:8888/notebooks/model_v2.ipynb#
ata_Science_2020_v2.xlsx'
...
print(model.predict([[5,1,0,3,433,121,8,61,14,80,91,83,36,27]]))
